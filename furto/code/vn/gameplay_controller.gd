...
func _ready() -> void:
	await async_set_location("res://assets/locations/placeholder/placeholder_location.tscn", 0.0)
	...
	await async_set_location("res://assets/locations/placeholder/placeholder_location.tscn", 1.0)
